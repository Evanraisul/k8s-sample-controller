...
import (
	...
	"github.com/evanraisul/k8s-sample-controller/pkg/generated/clientset/versioned/scheme"
...
func (c *SamplecontrollerV1alpha1Client) Evans(namespace string) EvanInterface {
	return newEvans(c, namespace)
}
